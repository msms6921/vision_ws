...
#include "vision_interfaces/msg/detail/detected_object_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const vision_interfaces::msg::DetectedObject &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const vision_interfaces::msg::DetectedObjectArray & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: objects
  {
    ...
    for (size_t i = 0; i < size; i++) {
      vision_interfaces::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  vision_interfaces::msg::DetectedObjectArray & ros_message)
{
  // Member: header
  ...
  // Member: objects
  {
    ...
    for (size_t i = 0; i < size; i++) {
      vision_interfaces::msg::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: objects
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        vision_interfaces::msg::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: objects
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        vision_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_DetectedObject(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = vision_interfaces::msg::DetectedObjectArray;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const vision_interfaces::msg::DetectedObjectArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<vision_interfaces::msg::DetectedObjectArray *>(
    untyped_ros_message);
...
{
  return &vision_interfaces::msg::typesupport_fastrtps_cpp::_DetectedObjectArray__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vision_interfaces, msg, DetectedObjectArray)() {
  return &vision_interfaces::msg::typesupport_fastrtps_cpp::_DetectedObjectArray__handle;
}
